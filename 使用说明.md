...
# YOLOV8环境配置
    ...
    4. 额外需要的包安装命令:
        pip install timm==0.9.5 thop efficientnet_pytorch==0.7.1 einops grad-cam==1.4.8 dill==0.3.6 albumentations==1.3.1 pytorch_wavelets==1.3.0 -i https://pypi.tuna.tsinghua.edu.cn/simple
