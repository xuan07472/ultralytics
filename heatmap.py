...
class yolov8_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/GradCAMPlusPlus.png')
        
def get_params_CBAM():
    params = {
        'weight': '/home/ubuntu/ultralytics/runs/train/b150n_CBAM_c/weights/best.pt', # CBAM
...
def get_params_CA():
    params = {
        'weight': '/home/ubuntu/ultralytics/runs/train/b150n_CoordAtt_c/weights/best.pt', # CoordAtt, CA
...
def get_params_SE():
    params = {
        'weight': '/home/ubuntu/ultralytics/runs/train/b150n_SEAttention_c/weights/best.pt', # SE
...
def get_params_TAM():
    params = {
        'weight': '/home/ubuntu/ultralytics/runs/train/b150n_Triplet_c/weights/best.pt', # TAM
...
if __name__ == '__main__':
    image_path = '/home/ubuntu/ultralytics/datasets/luderick_base/images/train/05C1_Luderick_1_002400.jpg'
    output_path = 'heatmap'
    
    model = yolov8_heatmap(**get_params_CBAM())
    model(image_path, output_path + '/CBAM')
    
    model = yolov8_heatmap(**get_params_CA())
    model(image_path, output_path + '/CA')
    
    model = yolov8_heatmap(**get_params_SE())
    model(image_path, output_path + '/SE')
    
    model = yolov8_heatmap(**get_params_TAM())
    model(image_path, output_path + '/TAM')